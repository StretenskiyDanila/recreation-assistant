...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, user.id) && Objects.equals(username, user.username)
                && Objects.equals(telegramChatId, user.telegramChatId) && Objects.equals(city, user.city)
                && Objects.equals(currentState, user.currentState) && Objects.equals(healthTags, user.healthTags)
                && Objects.equals(dishTags, user.dishTags) && Objects.equals(mealTags, user.mealTags)
                && Objects.equals(cuisineTags, user.cuisineTags);
    }
